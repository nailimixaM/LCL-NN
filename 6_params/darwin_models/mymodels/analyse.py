...
dat = np.load('predictions_5.npy',allow_pickle=True)
print(dat.shape)
...
for i in range(401):
    for j in range(4):
        ...
        Kij,eij,Mij,vij,fij,bij=tij[0,:6]
        Kt.append(Kij)
        et.append(eij)
        Mt.append(Mij)
        vt.append(vij)
        ...
        Kij,eij,Mij,vij,fij,bij=pij[0,:6]
        Kp.append(Kij)
        ep.append(eij)
        Mp.append(Mij)
        vp.append(vij)
